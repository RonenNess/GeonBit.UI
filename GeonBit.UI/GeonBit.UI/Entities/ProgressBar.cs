...
namespace GeonBit.UI.Entities
{
    ...
    public class ProgressBar : Slider
    {
        ...
        override protected void DrawEntity(SpriteBatch spriteBatch)
        {
            ...
            DrawUtils.DrawSurface(spriteBatch, barTexture, _destRect, new Vector2(progressbarFrameWidth, 0f), 1, FillColor);
            ...
            ProgressFill.SetOffset(new Vector2(_frameActualWidth / UserInterface.SCALE, 0));
            ProgressFill.Size = new Vector2(markWidth, _destRectInternal.Height) / UserInterface.SCALE;
